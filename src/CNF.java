...
public class CNF {
    ...
    public CNF(String startSymbol, List<String> nonTerminal, List<String> terminals, Map<String, List<String>> productions) {
    ...
    public CNF freeGrammarToCNF() {
        System.out.println("Original:");
        printProduction();

        eliminateEpsilon();
        System.out.println("After Epsilon removal:");
        printProduction();

        eliminateUnitProductions();
        System.out.println("After removal of Unit Production:");
        printProduction();

        eliminateInaccessibleSymbols();
        System.out.println("After removal of Inaccessible Symbols:");
        printProduction();

        eliminateNonproductive();
        System.out.println("After removal of Nonproductive Symbols:");
        printProduction();
